...
---
# Azure ContainerApps API client library for JavaScript - version 1.1.2-alpha.20221004.1 
...
[API reference documentation](/javascript/api/@azure/arm-appcontainers) |
