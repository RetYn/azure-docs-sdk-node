...
---
# Azure ServiceBusManagement client library for JavaScript - version 6.0.1-alpha.20221003.1 
...
[API reference documentation](/javascript/api/@azure/arm-servicebus) |
