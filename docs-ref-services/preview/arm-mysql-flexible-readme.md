...
ms.service: mysql
---
# Azure MySQLManagementFlexibleServer client library for JavaScript - version 3.0.1-alpha.20221003.1 
...
[API reference documentation](/javascript/api/@azure/arm-mysql-flexible) |
